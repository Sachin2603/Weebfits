...
<body>
    ...
    <h3>Welcome to Weebfits!</h3>
    <h5>Please enter the following details in order to create your Weebfits account<h5>

    <form action="functions.php" method=post>
        <table >
            <tr>
                <td>Weebfits Registration Page</td>
            </tr>
            <tr>
                <td>Name :</td>
                <td><input type="text" name="fname" size=20 maxlength=20 required></td>
            </tr>
            <tr>
                <td>Surname :</td>
                <td><input type="text" name="lname" size=20 maxlength=20 required></td>
            </tr>
            <tr>
                <td>E-mail :</td>
                <td><input type="text" name="email" size=20 maxlength=20 required></td>
            </tr>
            <tr>
                <td>Password :</td>
