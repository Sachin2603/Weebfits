...
<body>
	...
	<h1>Welcome to the Weebfits Login Page</h1><br><br>

	<form  action="loginfunctions.php" method="post">
	<h3>Weebfits Login Form</h3><br>
	<p>Email:  <input type="text" name="email" size=20 maxlength=20 required></p>
	<p>Password:  <input type="password" name="password" size=20 maxlength=20 required></p>
	<input type = "submit" value="SUBMIT" name="submit" class="submit">
  
   	</form>
	<br>
    <h4>Dont have an account? Click <a href="registration.php">here</a> to go to our registration page.</h4>
    <h5>Login as an <a href="adminlogin.php">admin</a></h5>
	<br>
	</div>
